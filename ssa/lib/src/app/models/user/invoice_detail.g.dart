...
InvoiceDetail _$InvoiceDetailFromJson(Map<String, dynamic> json) =>
    InvoiceDetail(
      ...
      billingCycle: json['billingCycle'] as int?,
      ...
      creditApplied: json['creditApplied'] as bool,
      deliveryMethodType: json['deliveryMethodType'] as int,
      deliveryMethodTime: DateTime.parse(json['deliveryMethodTime'] as String),
...
Map<String, dynamic> _$InvoiceDetailToJson(InvoiceDetail instance) =>
    <String, dynamic>{
      ...
      'deliveryMethodTime': instance.deliveryMethodTime.toIso8601String(),
