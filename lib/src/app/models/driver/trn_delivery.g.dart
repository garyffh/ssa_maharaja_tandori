...
part of 'trn_delivery.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TrnDelivery _$TrnDeliveryFromJson(Map<String, dynamic> json) => TrnDelivery(
      ...
      items: (json['items'] as List<dynamic>)
          .map((e) => TrnDeliveriesItem.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$TrnDeliveryToJson(TrnDelivery instance) =>
    <String, dynamic>{
