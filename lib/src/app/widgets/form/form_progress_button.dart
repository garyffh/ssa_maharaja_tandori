...
class FormProgressButton extends StatelessWidget {
  const FormProgressButton(
      {required this.text,
      this.iconData,
  ...
  Widget build(BuildContext context) {
    return ElevatedProgressButton(
      ...
      size: context.watch<MediaSettingsBloc>().state.sp20,
      radius: context.watch<MediaSettingsBloc>().state.sp20,
      padding: context.watch<MediaSettingsBloc>().state.sp14,
      minWidth: context.watch<MediaSettingsBloc>().state.sp34,
      // size + padding
      maxWidth: context.watch<MediaSettingsBloc>().state.sp(65),
