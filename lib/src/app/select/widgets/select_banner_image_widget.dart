...
class SelectBannerImageWidget extends StatelessWidget {
  const SelectBannerImageWidget({
      ...
      child: ClipRect(
        child: FittedBox(
          ...
          child: CachedNetworkImage(
            ...
            height: 270,
            imageUrl:
            'https://${PackageConstants.webSiteUrl}/${storeSettings.imagesPath}/banner1.jpg',
